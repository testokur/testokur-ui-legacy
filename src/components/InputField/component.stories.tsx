...
storiesOf('InputField', module)
  .add('Multi row ( textarea) empty', () => <InputField onChange={action('change')} label="Multi row ( textarea) empty" rows={3} />)
  ...
  .add('TextInput empty', () => <InputField onChange={action('change')} label="Empty input" />)
